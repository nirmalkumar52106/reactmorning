            ...
            if(password.length>0){
                if(confirm.length>0){
                    if(password===confirm){
                        console.log(data)
                        setInterval(() => {
                            seterrormsg("User signup successfulyy...")
                        setsuccess(true)
                        setloader(false)
                        }, 2000);
    ...
    return(
        ...
        <form>
            ...
            <button onClick={handlesignup}>
                {loader===true ? <img style={{height:"30px",width:"30px"}} src="https://i.gifer.com/origin/8b/8b4d5872105584fe9e2d445bea526eb5_w200.gif"/> : "Signup"}
            </button>
        </form>
